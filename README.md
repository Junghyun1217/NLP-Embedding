...
* *\[여기에 마지막 단계에서 출력된 **정확도/손실 시각화 그래프 이미지**를 첨부해야 합니다.]*
...
1.  **노트북 파일:** [감성 분석 $\text{Colab}$ 노트북 바로가기](./sentiment_analysis_lstm.ipynb) (파일 이름 수정 필요)
...
$\text{YOLO}$에 이어 성공적으로 **두 번째 딥러닝 포트폴리오**를 완성하셨습니다. 다음으로 진행하고 싶은 프로젝트가 있다면 알려주세요!
